...
#include <kth_franka_controllers/kth_joint_accelaration_effort_interface_controller.h>
#include <cmath>
#include <functional>
#include <memory>
...
PLUGINLIB_EXPORT_CLASS(
    kth_franka_controllers::KthJointAccelerationEffortInterfaceController,
