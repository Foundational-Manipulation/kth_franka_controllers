...
#include <kth_franka_controllers/kth_dual_arm_centroid_pose_effort_interface_controller.h>
...
#include <kth_franka_controllers/pseudo_inversion.h>
#include <franka_hw/trigger_rate.h>
#include <geometry_msgs/PoseStamped.h>
#include <kth_franka_controllers/CoopCentroidFormationDelta.h>
...
namespace kth_franka_controllers {
...
void KthDualArmCentroidPoseEffortInterfaceController::updateArm(CustomFrankaDataContainerDualArmPose& arm_data, const string& arm_id, const ros::Duration& period){
 ...
 // Get Euler angles and check continuity
  ...
  Eigen::MatrixXd pJa; 
  //kth_franka_controllers::pseudoInverse(Ja, pJa); 
...
// PD control
  ...
  kth_franka_controllers::pseudoInverse(jacobian.transpose(), jacobian_transpose_pinv);
...
PLUGINLIB_EXPORT_CLASS(
    kth_franka_controllers::KthDualArmCentroidPoseEffortInterfaceController,
