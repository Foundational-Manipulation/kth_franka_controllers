...
#include <kth_franka_controllers/kth_joint_pose_effort_interface_controller.h>
#include <cmath>
#include <functional>
#include <memory>
...
void KthJointPoseEffortInterfaceController::targetJointCallback(const geometry_msgs::PoseStamped::ConstPtr& msg, const string& robot_id){
  ...
  //arm_data.planner_q_.initQ(arm_data.initial_q_, current_time_); 
  arm_data.planner_q_.planQ(arm_data.initial_q_,pose_des_q_, current_time_, 0.1); 
...
PLUGINLIB_EXPORT_CLASS(
    kth_franka_controllers::KthJointPoseEffortInterfaceController,
